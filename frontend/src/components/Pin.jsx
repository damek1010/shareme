        ...
        <div className="m-2">
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex gap-2">
                                ...
                                className="bg-white w-9 h-9 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md overflow-hidden"
                                >
            ...
            >
                <img 
                    ...
                    alt="user-profile"
                />
                <p className="semi-bold capitalize">
                    {postedBy?.userName}
                </p>
            </Link>
        </div>
